...
public class QuoteConfimationAPITest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(QuoteConfimationAPITest.class);
    ...
    /*
        #Usecase - 1 - **QUOTE CONFIRMATION**
     */
    @Test
    public void testQuoteConfrmation() {
        logger.info("Running Usecase - 1, QUOTE CONFIRMATION.");
